...
|-------------|-----------|-------------|
| **🔒 AuthAPI** | FastAPI · MongoDB · JWT | Secure authentication API with Docker, Swagger UI, and token-based access |
| **📱 Class Manager** | Flutter · Firebase · Push Notifs | Realtime classroom interaction app with attendance and communication |
| **🗳️ Voting App** | React · Python · Face Recognition | Facial-recognition-based secure voting prototype |
| **📦 Automations** | Python · Selenium | Custom automation scripts to make life 10x easier |
